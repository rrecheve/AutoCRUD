...
/**
 * This class contains the data previously parsed. It is needed to create the DeleteUnit in the WebRatio Model using generate method.
 */
public class DeleteUnit extends UnitOutsidePage {
	...
	public IMFElement generate(Map<String, IMFElement> createdElements) {
		...
		WebRatioCalls newUnitWRCall = new NewUnit(this.parent, ElementTypes.DELETE_UNIT, this.position.x, this.position.y, this.name,
				this.entity);
