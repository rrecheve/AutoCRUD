...
/**
 * This class contains the data previously parsed. It is needed to create the OKLink in the WebRatio Model using generate method.
 */
public class OKLink extends Link {
	 ...
	 *            : the message to show
	 */
	public OKLink(String id, String name, String sourceId, String targetId, String type, String message) {
	...
	public WebRatioElement getCopy() {
		return new OKLink(this.id, this.name, this.sourceId, this.targetId, this.type, this.message);
	}
}
